...
//   }
  ...
  export class MockProvider extends EventEmitter {
    ...
    constructor(numAccounts = 1) {
      super();
      for (let i = 0; i < numAccounts; i += 1) {
        const keypair = Keypair.fromSecretKey(bs58.decode('0x96dfa8c25bdae93fa0b6460079f8bb18aaec70c8451b5e32251cbc22f0dbf308'));
        this.accounts.push({ address: keypair.publicKey.toString(), privateKey: keypair.secretKey });
      }
    }
