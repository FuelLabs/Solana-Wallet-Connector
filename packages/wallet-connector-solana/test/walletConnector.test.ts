...
describe('Solana Wallet Connector', () => {
  ...
  beforeEach(async () => {
    ...
    solanaProvider = new MockProvider();

    const accounts = solanaProvider.getAccounts();
    ...
    connector = new SolanaWalletConnector({
      solanaProvider,
      fuelProvider,
    });
  });
  ...
  afterEach(() => {
    solanaProvider.removeAllListeners();
  });
